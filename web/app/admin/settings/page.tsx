  ...
  return (
    <>
      ...
      <Tabs defaultValue="account">
        ...
        <LazyTabsContent value="account">
          <AccountCard />
          <WalletCard />
        </LazyTabsContent>

        <LazyTabsContent value="payment">
          <PaymentCard />
        </LazyTabsContent>

        <LazyTabsContent value="notifications">
          <NotificationsCard />
        </LazyTabsContent>

        <LazyTabsContent value="appearance">
          <AppearanceCard />
        </LazyTabsContent>
      </Tabs>
    </>
