...
export function CartSummary({ itemCount = 0, totalAmount = 0, onGeneratePayment }: CartSummaryProps) {
  return (
    <div className="fixed bottom-16 left-0 right-0 max-w-md mx-auto bg-white border-t p-4 shadow-md">
      ...
      <Button className="w-full bg-blue-600 hover:bg-blue-700" onClick={onGeneratePayment}>
